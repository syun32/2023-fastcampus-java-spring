...
<html>
<head>
<title>[고객등록] 도서 고객 및 대여관리 프로그램</title>
<link
	...
	<section class="container px-5">
		<div class="container py-3">
			<form:form name="frm" modelAttribute="user">
				<h5 class="text-center">고객등록화면</h5>
			    
				<div class="input-group py-3">
				  <span class="input-group-text">고객번호</span>
				  <input type="text" class="form-control bg-light" name="cust_no" value="${cust_no}" readonly>
				</div>
				<div class="input-group pb-3">
				  <span class="input-group-text">고객이름</span>
				  <input type="text" class="form-control" name="cust_name" placeholder="홍길동" autofocus>
				</div>
				<div class="input-group pb-3">
				...
				<div class="input-group pb-3">
				  ...
				  <input type="text" class="form-control" name="cust_email" placeholder="1111@fastcampus.com">
				</div>
				<div class="input-group pb-3">
				  <span class="input-group-text">고객등급(P,G,S)</span>
				  <input type="text" class="form-control" name="grade" placeholder="P, G, S">
				</div>
				<div class="text-center pb-3">
       				<button type="button" onclick="formCheck()" class="btn btn-primary">등록</button>
       				<button type="button" onClick="location.href='<c:url value='/'/>'" class="btn btn-secondary">취소</button>
       			</div>
